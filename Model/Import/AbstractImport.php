...
use Aimsinfosoft\Base\Model\Import\Behavior\BehaviorProviderInterface;
use Aimsinfosoft\Base\Model\Import\Mapping\MappingInterface;
use Aimsinfosoft\Base\Model\Import\Validation\EncodingValidator;
use Aimsinfosoft\Base\Model\Import\Validation\ValidatorPoolInterface;
...
abstract class AbstractImport extends AbstractEntity
{
    ...
    protected function processValidation(array $rowData)
    {
        ...
        foreach ($this->validatorPool->getValidators() as $validator) {
            ...
            } catch (\Aimsinfosoft\Base\Exceptions\StopValidation $exception) {
